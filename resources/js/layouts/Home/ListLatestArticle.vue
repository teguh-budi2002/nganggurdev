  ...
  <section class="w-full h-full mt-5">
    <div class="flex items-center justify-center">
      <div class="w-11/12 h-full">
        <div>
          <p class="md:text-start text-center md:text-5xl text-3xl font-['Bebas_Neue'] font-bold text-slate-600 tracking-wider" v-html="$t('home.latest_article')"></p>
        </div>
        <p class="md:text-start text-center font-['Roboto'] md:text-base text-sm font-light">{{ $t('collection.latest_article') }}</p>

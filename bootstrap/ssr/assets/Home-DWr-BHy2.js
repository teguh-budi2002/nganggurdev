...
import { _ as _export_sfc, a as _sfc_main$5 } from "./AppLayout-BhogGyPD.js";
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "w-full h-full mt-10" }, _attrs))} data-v-94480883><div class="flex items-center justify-center" data-v-94480883><div class="w-11/12 h-full" data-v-94480883><div data-v-94480883><p class="md:text-start text-center md:text-5xl text-3xl font-[&#39;Bebas_Neue&#39;] font-bold text-slate-600 tracking-wider" data-v-94480883>${_ctx.$t("article.featured") ?? ""}</p></div><p class="md:text-start text-center font-[&#39;Roboto&#39;] md:text-base text-sm font-light" data-v-94480883>${ssrInterpolate(_ctx.$t("collection.featured_article"))}</p>`);
      if (featuredArticles.value.length > 0) {
        _push(`<div class="articles grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 md:mt-10 mt-8 mb-10" data-v-94480883><!--[-->`);
        ssrRenderList(featuredArticles.value, (article) => {
          _push(`<div class="w-full h-fit hover:shadow-xl transition-shadow duration-300 shadow-sm" data-v-94480883>`);
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                }, ssrGetDirectiveProps(_ctx, _directive_lazy, `/storage/${article.image}`)))} data-v-94480883${_scopeId}>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : _temp0.innerHTML ?? ""}`);
              } else {
                return [
          ...
          _push(`<div class="px-4 py-4 h-56 flex flex-col justify-between border-l border-r border-b border-slate-100 rounded-b-lg" data-v-94480883><div data-v-94480883>`);
          _push(ssrRenderComponent(unref(Link), {
            href: _ctx.route("article.show", { locale: unref(locale), slug: article.slug }),
          ...
          _push(`</div><div class="authror w-full flex items-center justify-between border-t border-slate-300 pt-2" data-v-94480883><div class="categories flex items-center space-x-2" data-v-94480883><!--[-->`);
          ssrRenderList(article.categories, (category) => {
            _push(`<div class="w-fit" data-v-94480883>`);
            _push(ssrRenderComponent(unref(Link), {
              href: "",
              class: ""
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<img${ssrRenderAttr("src", `/storage/${category.img_category}`)} class="w-5 h-5" alt="logo icon" data-v-94480883${_scopeId}>`);
                } else {
                  return [
                    createVNode("img", {
          ...
          _push(`<!--]--></div><p class="font-[&#39;Roboto&#39;] text-sm font-light text-slate-700 text-end" data-v-94480883>${ssrInterpolate(article.author.name)}</p></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="flex justify-center w-full" data-v-94480883><img src="/assets/images/article-not-found.webp" alt="article not found" class="w-96 mx-auto h-auto" data-v-94480883></div>`);
      }
...
const ListFeaturedArticle = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-94480883"]]);
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_lazy = resolveDirective("lazy");
      let _temp0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "w-full h-full mt-5" }, _attrs))} data-v-904c6b6b><div class="flex items-center justify-center" data-v-904c6b6b><div class="w-11/12 h-full" data-v-904c6b6b><div data-v-904c6b6b><p class="md:text-start text-center md:text-5xl text-3xl font-[&#39;Bebas_Neue&#39;] font-bold text-slate-600 tracking-wider" data-v-904c6b6b>${_ctx.$t("home.latest_article") ?? ""}</p></div><p class="md:text-start text-center font-[&#39;Roboto&#39;] md:text-base text-sm font-light" data-v-904c6b6b>${ssrInterpolate(_ctx.$t("collection.latest_article"))}</p>`);
      if (articles.value.length > 0) {
        _push(`<div class="articles grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 md:mt-10 mt-8 mb-10" data-v-904c6b6b><!--[-->`);
        ssrRenderList(articles.value, (article) => {
          _push(`<div class="w-full h-fit hover:shadow-xl transition-shadow duration-300 shadow-sm" data-v-904c6b6b>`);
          _push(ssrRenderComponent(unref(Link), {
            href: _ctx.route("article.show", { locale: unref(locale), slug: article.slug })
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttrs(_temp0 = mergeProps({
                  alt: "article image",
                  class: "w-full h-full cursor-pointer rounded-t-lg"
                }, ssrGetDirectiveProps(_ctx, _directive_lazy, `/storage/${article.image}`)))} data-v-904c6b6b${_scopeId}>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : _temp0.innerHTML ?? ""}`);
              } else {
                return [
                  withDirectives(createVNode("img", {
                    alt: "article image",
          ...
          _push(`<div class="px-4 py-4 h-56 flex flex-col justify-between border-l border-r border-b border-slate-100 rounded-b-lg" data-v-904c6b6b><div data-v-904c6b6b>`);
          _push(ssrRenderComponent(unref(Link), {
            href: _ctx.route("article.show", { locale: unref(locale), slug: article.slug }),
            class: "font-['Inter'] font-bold text-lg text-slate-600 hover:text-sky-700 transition-colors duration-300 cursor-pointer tracking-wide"
          }, {
          ...
          _push(`</div><div class="authror w-full flex items-center justify-between border-t border-slate-300 pt-2" data-v-904c6b6b><div class="categories flex items-center space-x-2" data-v-904c6b6b><!--[-->`);
          ssrRenderList(article.categories, (category) => {
            _push(`<div class="w-fit" data-v-904c6b6b>`);
            _push(ssrRenderComponent(unref(Link), {
              href: "",
              class: ""
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<img${ssrRenderAttr("src", `/storage/${category.img_category}`)} class="w-5 h-5" alt="logo icon" data-v-904c6b6b${_scopeId}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: `/storage/${category.img_category}`,
          ...
          _push(`<!--]--></div><p class="font-[&#39;Roboto&#39;] text-sm font-light text-slate-700 text-end" data-v-904c6b6b>${ssrInterpolate(article.author.name)}</p></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="flex justify-center w-full" data-v-904c6b6b><img src="/assets/images/article-not-found.webp" alt="article not found" class="w-96 mx-auto h-auto" data-v-904c6b6b></div>`);
      }
      _push(`</div></div><div class="flex justify-center" data-v-904c6b6b><div class="bg-white w-fit mt-5 mb-10 p-2 px-4 border border-slate-200 rounded-full shadow-sm animate-bounce" data-v-904c6b6b><p class="font-[&#39;Roboto&#39;] text-slate-700 flex items-center space-x-1" data-v-904c6b6b>${ssrInterpolate(_ctx.$t("visit.more.articles"))}? `);
      _push(ssrRenderComponent(unref(Link), {
...
const ListLatestArticle = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-904c6b6b"]]);
const _sfc_main$2 = {};

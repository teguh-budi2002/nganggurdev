...
const en = {
  ...
  "navigation.section.5": "Our Products",
  ...
  "article.new": "<span class='text-rose-400'>Featured</span> Articles",
  "collection.material": "A collection of the latest materials to support your learning process.",
...
const id = {
  ...
  "navigation.section.5": "Produk Kami",
  ...
  "article.new": "Artikel <span class='text-red-400'>Unggulan</span>",
  "collection.material": "Kumpulan materi terbaru yang dapat membantu proses belajarmu.",
  copyright,
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Article/Index.vue": () => import("./assets/Index-OQlRMRE0.js"), "./Pages/Article/Show.vue": () => import("./assets/Show-Ca0Q1ZWr.js"), "./Pages/Home.vue": () => import("./assets/Home-hKyAoYlj.js"), "./Pages/Product/Index.vue": () => import("./assets/Index-WucXEhk_.js") })),

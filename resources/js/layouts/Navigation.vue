    ...
    >
      <div class="flex items-center justify-between xl:w-2/7 w-2/4">
        ...
        <div class="space-x-4 lg:block hidden">
          <Link :href="`/${locale}`" @click="resetState" class="font-['Roboto'] font-semibold text-lg hover:text-amber-600 dark:hover:text-white transition-colors duration-300 ease-in-out" :class="{ 'text-amber-600 dark:text-white' : page.component === 'Home', 'text-slate-600 dark:text-slate-400' : page.component !== 'Home' }">{{ $t('navigation.section.1') }}</Link>
